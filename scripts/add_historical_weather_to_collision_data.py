...
df = df.dropna(axis='rows', how='any', thresh=None, subset=['windSpeed', 'visibility'], inplace=False)
...
df_synthetic = df_synthetic.iloc[0:36444,:]

for name in df_real_weather.columns:
    df_synthetic[name] = df_real_weather[name].values
